...
python eval.py \
    ...
    --result_path results/mbpp_eb_sampler

python ../utils/judge_python_code.py \
    --folder_path results/mbpp_eb_sampler \
    --output_path results/mbpp_eb_sampler.txt
...
python eval.py \
    ...
    --result_path results/math500_eb_sampler.txt
...
python eval.py \
    ...
    --result_path results/sudoku_eb_sampler.txt
...
python eval.py \
    ...
    --result_path results/countdown_eb_sampler.txt
...
accelerate launch eval_llada.py \
    ...
    --model_args model_path='GSAI-ML/LLaDA-8B-Instruct',gen_length=256,steps=256,block_length=256,gamma=0.01,mode=eb_sampler
