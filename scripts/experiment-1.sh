...
generated_seqs_path_mirage=${BASE_PATH}/remdm/outputs/experiment_1/refine-ent-3_T-${sampling_steps}_L-${L}_k-${k}.json
generated_seqs_path_conf=${BASE_PATH}/remdm/outputs/experiment_1/remdm-conf_T-${sampling_steps}_L-${L}.json
generated_seqs_path_loop=${BASE_PATH}/remdm/outputs/experiment_1/remdm-loop_T-${sampling_steps}_L-${L}_eta-${eta}_ton-${t_on}_toff-${t_off}_alphaon-${alpha_on}.json
generated_seqs_path_mdlm=${BASE_PATH}/remdm/outputs/experiment_1/mdlm_T-${sampling_steps}_L-${L}.json
