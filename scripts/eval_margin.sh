...
python eval.py \
    ...
    --result_path results/mbpp_margin

python ../utils/judge_python_code.py \
    --folder_path results/mbpp_margin \
    --output_path results/mbpp_margin.txt
...
python eval.py \
    ...
    --result_path results/math500_margin.txt
...
python eval.py \
    ...
    --result_path results/sudoku_margin.txt
